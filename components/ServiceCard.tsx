...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, lang, index }) => {
  ...
  const getServiceImage = (id: number) => {
    switch(id) {
      case 1: return "https://images.unsplash.com/photo-1584622050111-993a426fbf0a?auto=format&fit=crop&q=80&w=400"; // Maid/Cleaning
      case 2: return "https://images.unsplash.com/photo-1577412647305-991150c7d163?auto=format&fit=crop&q=80&w=400"; // Cook
      case 3: return "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?auto=format&fit=crop&q=80&w=400"; // Nanny
      case 4: return "https://images.unsplash.com/photo-1581579438747-1dc8d17bbce4?auto=format&fit=crop&q=80&w=400"; // Elderly
      case 5: return "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?auto=format&fit=crop&q=80&w=400"; // Driver
      default: return "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&q=80&w=400"; // Generic
    }
  };
  ...
  return (
    ...
    >
      ...
      {/* Top Accent Line - Using Theme Colors */}
      ...
      <div className="p-6 relative z-10 flex flex-col items-center h-full">
        ...
        <div className="mb-6 relative inline-flex justify-center items-center">
             ...
             {/* 1. Pulsing/Expanding Outer Glow (Always Visible) - Using Theme Colors */}
             <div className="absolute inset-0 bg-tertiary/10 rounded-full scale-125 animate-pulse-glow"></div>
             
             {/* 2. Spinning Dashed Border (Always Visible) - Using Theme Colors */}
             ...
             <div className="w-28 h-28 rounded-full border-4 border-white shadow-xl overflow-hidden relative z-10 transform transition-all duration-500 group-hover:rotate-3 group-hover:border-tertiary/20">
                ...
                {/* Shine Effect Overlay (Still triggered on hover for interaction) */}
        ...
        {/* Action Button - Using Tertiary Color */}
        <div className={`mt-auto flex items-center justify-center text-tertiary font-bold transition-all duration-300 ${isAr ? 'group-hover:-translate-x-2' : 'group-hover:translate-x-2'}`}>
