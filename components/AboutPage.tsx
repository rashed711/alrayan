    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
            <div className="bg-gray-50 p-10 rounded-3xl border border-gray-100 hover:shadow-xl transition-shadow animate-fade-in-right">
            ...
            <div className="bg-primary text-white p-10 rounded-3xl border border-primary hover:shadow-xl transition-shadow animate-fade-in-left">
        ...
        <div className="text-center mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                {[
                    ...
                    <div key={idx} className="p-6 rounded-2xl bg-white shadow-lg hover:-translate-y-2 transition-transform duration-300 border border-gray-50">
