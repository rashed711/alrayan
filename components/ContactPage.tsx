    ...
    <div className="bg-gray-50 min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
                <ScrollReveal animation="fade-right" delay={0}>
                    <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 flex items-start gap-4 hover:border-tertiary/30 transition-colors">
        ...
        <ScrollReveal animation="fade-up" delay={400} className="mt-12">
            <div className="rounded-3xl overflow-hidden shadow-lg h-80 bg-gray-200 relative group">
                {/* Simulating a Map */}
